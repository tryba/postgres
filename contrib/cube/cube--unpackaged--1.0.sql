...
ALTER EXTENSION cube ADD function cube_hamming_distance(cube,cube);
...
ALTER EXTENSION cube ADD function g_cube_distance(internal, cube, integer, oid);
ALTER EXTENSION cube ADD function g_cube_hamming_distance(internal, cube, integer, oid);
